    ...
    >
      ...
      >
        <omsp-panel>
          ...
          <div v-if="item.title === '问题分类'" style="margin: 15px">
            <!--title-->
            <div style="width: 100%;display: flex;align-items: center;height: 30px;">
              <div style="flex: 1;font-size: 15px;font-family:PingFang-SC-Bold,PingFang-SC;font-weight:bold;color: #010025;">
                问题分类情况
              </div>
              <div style="flex: 1;text-align: right;display: flex;justify-content: flex-end;align-items: center">
                ...
                <div style="margin-left: 9px;width: 20px;height: 5px ;border-radius: 0px 50px 50px 0px;background-image: linear-gradient(to right, #075AE4 , #249DEB);" />
              </div>
            </div>
            <!--body-->
            <div
            ...
            >
              ...
              <div style="display: flex;margin-bottom: 20px">
                <div style="width: 80%">
                  <div :style="{'width':(itemCategory.value/(categoryMax?categoryMax:1)).toFixed(2)*100+'%','background-color':'red','height':'16px','margin-top':'10px','border-radius':'0px 50px 50px 0px','background-image': 'linear-gradient(to right, #075AE4 , #249DEB)'}" />
                </div>
          ...
          <!--                    <div v-if="item.title === '达成情况'" style="margin: 15px">-->
          <!--                        &lt;!&ndash;title&ndash;&gt;-->
          <!--                        <div style="width: 100%;display: flex;align-items: center;height: 30px;">-->
          <!--                            <div style="flex: 1;font-size: 15px;font-family:PingFang-SC-Bold,PingFang-SC;font-weight:bold;color: #010025;">-->
          <!--                                达成情况-->
          <!--                            </div>-->
          <!--                            <div style="flex: 1.5;text-align: right;display: flex;justify-content: flex-end;align-items: center">-->
          <!--                                <div style="font-size: 12px;color: #A6A8B5;margin-left: 5px">已完成</div>-->
          <!--                                <div style="margin-left: 9px;width: 20px;height: 5px ;border-radius: 0px 50px 50px 0px;background-image: linear-gradient(to right, #075AE4 , #249DEB);"></div>-->
          <!--                                <div style="font-size: 12px;color: #A6A8B5;margin-left: 5px">未完成</div>-->
          <!--                                <div style="margin-left: 9px;width: 20px;height: 5px ;border-radius: 0px 50px 50px 0px;background-image: linear-gradient(to right, #F5AC18 , #F3C871);"></div>-->
          <!--                            </div>-->
          <!--                        </div>-->
          <!--                        &lt;!&ndash;body&ndash;&gt;-->
          <!--                        <div-->
          <!--                                v-for="(itemAchieve,indexAchieve) in achieveArr"-->
          <!--                                :key="'iAchieve'+indexAchieve"-->
          <!--                        >-->
          <!--                            <div style="line-height: 16px;margin: 15px 0px 0px 0px;font-size: 15px" class="ellipsis">-->
          <!--                                {{itemAchieve.name}}-->
          <!--                            </div>-->
          ...
          <!--                                <div style="width: 80%">-->
          <!--                                    <div :style="{'width':(itemAchieve.achieveValue/(achieveMax===0?1:achieveMax)).toFixed(2)*100+'%','background-color':'red','height':'16px','margin-top':'10px','border-radius':'0px 50px 50px 0px','background-image': 'linear-gradient(to right, #075AE4 , #249DEB)'}">-->

          <!--                                    </div>-->
          <!--                                </div>-->
          <!--                                <div style="width: 20%;margin-top: 8px;text-align: right">-->
          <!--                                    {{itemAchieve.achieveValue}}-->
          <!--                                </div>-->
          <!--                            </div>-->
          <!--                            <div style="display: flex;margin-bottom: 20px">-->
          <!--                                <div style="width: 80%">-->
          <!--                                    <div :style="{'width':(itemAchieve.noAchieveValue/(achieveMax===0?1:achieveMax)).toFixed(2)*100+'%','background-color':'red','height':'16px','margin-top':'10px','border-radius':'0px 50px 50px 0px','background-image': 'linear-gradient(to right, #F5AC18 , #F3C871)'}">-->

          <!--                                    </div>-->
          <!--                                </div>-->
          <!--                                <div style="width: 20%;margin-top: 8px;text-align: right">-->
          <!--                                    {{itemAchieve.noAchieveValue}}-->
          <!--                                </div>-->
          <!--                            </div>-->
          <!--                            <van-divider dashed/>-->
          <!--                        </div>-->
        ...
        this.tab.forEach((ele, index) => {
          switch (ele.title) {
            ...
            case '问题分类':
              ...
              break
                            // case '达成情况':
                            //     ele.data.achieved = data.achived;
                            //     ele.data.noAchieved = data.noAchived;
                            //     break;
                            // case '满意度':
                            //     ele.data = data.satisfaction;
                            //     break;
          }
          // 重新渲染统计图
